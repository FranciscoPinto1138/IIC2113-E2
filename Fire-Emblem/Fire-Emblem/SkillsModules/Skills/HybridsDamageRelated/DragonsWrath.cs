...
public class DragonsWrath : Hybrid
{
    public DragonsWrath()
    {
        ...
        this.Description = "Reduce el daño del primer ataque del rival durante el combate en un 25%. Si el Atk de la unidad > Res del rival, el primer ataque de la unidad hace daño extra = 25% del Atk de la unidad menos Res del rival durante el combate.";
    }
