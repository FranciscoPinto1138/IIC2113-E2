...
public class MoonTwinWing : Skill
{
    public MoonTwinWing()
    {
        ...
        this.Description = "Al inicio del combate, si el HP de la unidad >= 25%, " +
                           "inflige Atk/Spd-5 en el rival durante el combate, y también, " +
                           "si la Spd de la unidad > Spd del rival, reduce el daño de los ataques " +
                           "del rival durante el combate en un porcentaje = diferencia " +
                           "entre los stats x 4 (máx. 40%).";
    }
