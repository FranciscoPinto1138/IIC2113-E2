...
public class Chivalry : Skill
{
    ...
    {
        this.Name = "Chivalry";
        this.Description = "Si la unidad inicia el combate contra un rival con HP=100%, " +
                           "la unidad inflige +2 daño en cada ataque y recibe -2 daño por cada ataque del rival.";
    }
